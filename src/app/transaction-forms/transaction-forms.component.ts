  ...
  customerDetails() {
   console.log(this.everything.customerId)
    this.EmployeeService.getCustomerById(
      ...
      this.everything.customerCategory=data.customerCategory;
      console.log(data.customerCategory)
      console.log(this.everything.customerCategory)
      this.everything.phone= data.phone;
      this.everything.email= data.emailId;
      this.everything.execName=data.executiveName;
      this.everything.territoryId = data.territory;
      ...
      //   this.employee.executiveCode = data.code;
      //   console.log(data.code)
      // });
      //this.mexecutiveService.getByExecutiveCode(this.)
